...
if st.button("calcular"):
    if peso > 0 and altura > 0: 
        ...
        if col1 == "Peso ideal":
            col1.metric("Classificação", classe, f"{imc_delta:.2f}", "Sem necessidade de mudanças")  
            col2.metric("IMC", f"{imc:.2f}", f"{imc_delta:.2f}")
            
        elif col1 == "Abaixo do peso":
...
# tabela IMC 
path = 'C:/Users/User/Downloads/unnamed.png'
...
with tab1:
    ...
    # imagem sobre o tema:
    st.image('C:/Users/User/Downloads/overweight-girl-with-healthy-unhealthy-food-scaled.jpg', width = 10000)
